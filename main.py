...
# ═══════════════════════════════════════════════════════════════════
# PART 5: ADMIN PANEL INPUTS HANDLER
# ═══════════════════════════════════════════════════════════════════
    ...
    try:
        ...
        # Contact Admin
            ...
            await update.message.reply_text(
                ...
                f"━━━━━━━━━━━━━━━━━━━━━\n"
                f"👑 {to_small_caps('Owner:')} {ADMIN_USERNAME}\n"
                f"💬 {to_small_caps('Click the username to message directly')}\n"
                f"━━━━━━━━━━━━━━━━━━━━━"
            )
        ...
        elif text in ["🔒 ʟᴏᴄᴋ sʏsᴛᴇᴍ", "🔓 ᴜɴʟᴏᴄᴋ sʏsᴛᴇᴍ", "👤 ʟᴏᴄᴋ ᴜsᴇʀ",
                      "🔓 ᴜɴʟᴏᴄᴋ ᴜsᴇʀ", "➕ ᴀᴅᴅ ᴀᴅᴍɪɴ", "➖ ʀᴇᴍᴏᴠᴇ ᴀᴅᴍɪɴ",
                      "📢 sᴍs ᴀʟʟ", "📨 ᴘʀɪᴠᴀᴛᴇ ᴍsɢ", "🚫 ʙʟᴏᴄᴋ", "✅ ᴜɴʙʟᴏᴄᴋ",
                      "➕ ᴀᴅᴅ ᴄʜᴀɴɴᴇʟ", "➖ ʀᴇᴍᴏᴠᴇ ᴄʜᴀɴɴᴇʟ", "🔄 ᴀᴜᴛᴏ ʀᴇsᴛᴀʀᴛ",
                      "🛡️ ʀᴇᴄᴏᴠᴇʀʏ", "🎬 ᴘʀᴏᴊᴇᴄᴛ ғɪʟᴇs", "📋 ᴀʟʟ ᴘʀᴏᴊᴇᴄᴛs",
                      "🪐 ʀᴇsᴛᴀʀᴛ ᴀʟʟ", "👥 ᴜsᴇʀs"]:
            ...
            for p_name, d in list(project_owners.items()):
                try:
                    ...
                    if file_to_send and os.path.exists(file_to_send):
                        ...
                        await update.message.reply_text(
                            f"⚠️ {p_name_escaped}\n❌ {escape_markdown(to_small_caps('Zip file not found'))}",
                            parse_mode='MarkdownV2'
                        )
